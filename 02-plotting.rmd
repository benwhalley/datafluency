...
and upload to rstudio, or [read directly from this url](#read-data-from-url)).
...
measure of variability) in each group. You can ignore the warning about
...
If you are short of time you can treat this section like an extension exercise. It might be useful
