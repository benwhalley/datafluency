...
We will use the short [lifesavR course](https://benwhalley.github.io/lifesavR/). We cover these 5 worksheets in 4 sessions, with a little independent study.

- Session 1: [Getting started](https://benwhalley.github.io/lifesavR/session-1.html) and [Working with R](https://benwhalley.github.io/lifesavR/session-2.html)
- Session 2:  [Grouped data](https://benwhalley.github.io/lifesavR/session-3.html)
- Session 3:  [Describing patterns, answering questions](https://benwhalley.github.io/lifesavR/session-4.html)
- Session 4:  [Quantifying evidence](https://benwhalley.github.io/lifesavR/session-5.html)
...
approach. Workshops might teach how to "do an Anova", or "how to run a multiple
...
[Wickham et al., 2023](https://r4ds.hadley.nz/intro.html) (see figure):

![Wickham's model of a data science workflow](images/data-science.png)

In this module we do cover specific skills, but these are embedded within a broader approach to working with data, and you will learn to integrate them into your own research.
...
The most important thing of all is to **practise**. These materials provide lots of practice tasks. You **need** to work through them all to pass the module.
...
If you are taking this course at the University of Plymouth, the easiest way to run the
code examples here is to use the school's RStudio Server.

-   [Log in to your account on the server here](https://psyrstudio.plymouth.ac.uk)
-   To get an account on the server, or reset a password,
    [contact the Psychology technical office](http://www.psy.plymouth.ac.uk/)
