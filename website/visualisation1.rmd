...
**Extension exercise: Adding text**

To learn how to add text to the plot above, see this brief guide:

<http://www.sthda.com/english/wiki/ggplot2-texts-add-text-annotations-to-a-graph-in-r-software>


1. Try adding text to your new version ogf Bae Fig. 1 which includes the text from the original (note that the original Figure itself is a little misguided in providing two separate *p* values — but we will deal with that in a later workshop).
