...
Throughout this worksheet (and others on the course), you'll see the code you should type into
...
New functions in the worksheets are followed by one or more _explanation_ sections --- those are there
to help you understand how the code works and how to read the output they produce.
...
These sections are exercises for you to complete. They are the most important sections in the
