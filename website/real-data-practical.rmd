...
If so, a point-range plot is better:
...
```{r, echo=F}
step1 <- egger.subset %>% 
  set_names(c("id", "condition", "gender", "maths 1", "maths 2", "spelling 1", "spelling 2", "reading 1", "reading 2")) %>% 
...
- Use `stat_summary` (as shown above) to plot the mean and standard errors, as shon in Egger Figure 2 (an example is shown below).
