...
```{r}
XXX NEED TO ADD stat_summary(geom="bar") and position="dodge" to this worksheet for the assessment
```
...
*This is an optional exercise and is not required for the course assessment. 
Skip to the final section if you are short on time.*
