...
file over the internet, and stores it in the variable called `expdata`. We then use `glimpse` to 
check the data
...
I think that third point is slightly harder to read in plot B.
...
1. Re-organise the plot below to make it easier to see which level of education 
