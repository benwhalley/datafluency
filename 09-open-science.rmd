...
Note that I may add to this document as we move through the course, responding to questions/issues that arise. The RMarkdown task will remain though, so if you want to complete that in advance feel free.
