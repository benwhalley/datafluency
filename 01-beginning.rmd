...
For example, if [we previously](#loading-data) downloaded data from
...
2. Describe the plot
3. What pre-processing step might we want to use, before plotting (hint: in this experiments, most
