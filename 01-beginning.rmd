...
First, we need to create a list of each of the possible values for our categories:
...
In our example, each of the experimental conditions is allocated between-participants, which (as you'll learn
