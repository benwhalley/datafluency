...
(If you're doing this exercise on your own at home, the examples are available here:
[example-plots.pdf](regression-example-plots.pdf).

The data for the example included:

-   MCQ test data (i.e. a measure of academic achievement)
...
Your task was to describe the **_relationship between hours spent working and exam grades_** with
...
1. As a **map**, they **summarise** and **describe** the data we have, but they are also
