...
If you want to recap these commands you can use [the cheatsheet](00-glossary-and-cheatsheet.html), especially
...
- We covered using `summarise` in the first and second worksheets. If you want a reminder, the [cheatsheet](00-glossary-and-cheatsheet.html) might be the quickest place to look
