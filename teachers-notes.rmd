...
- Sharpies
- Printed out [example-plots.pdf](regression-example-plots.pdf) (give several to each group to avoid swapping)
...
Relates to: [second regression session including causal models](#regression2)
