...
> The difference in rates of cooperation between men and women was relatively small `r g[2]` vs `r g[1]`, `r apastats::describe.ttest(t.test(cooperation~sex, data=guyer))`).
