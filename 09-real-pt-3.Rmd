...
[Slides from the session](slides/real_4.pptx)
...
ggsave('~/Desktop/pairspoint5.png')
...
ggsave('~/Desktop/pairspoint5diffmeans.png')
...
MASS::mvrnorm(n = N, mu = my_means, Sigma = my_covariances) %>% 
  as_tibble() %>% 
  ggpairs(lower = list(continuous = wrap("smooth")))
ggsave('~/Desktop/pairspoint5diffmeanscovars.png')
...
MASS::mvrnorm(n = N, mu = my_means, Sigma = my_covariances) %>% 
  ...
  ggpairs(lower = list(continuous = wrap("smooth")))
ggsave('~/Desktop/corrswitherrors.png')
